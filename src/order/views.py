    ...
    def post(self, request, *args, **kwargs):
        ...
        with transaction.atomic():
            ...
            if valid_seats.count() != len(seat_ids):
                return Response({"detail": "One or more seats are invalid or do not belong to this theater."}, status=status.HTTP_400_BAD_REQUEST)
            ...
            if already_purchased:
                return Response({"detail": "One or more seats are already reserved or purchased."}, status=status.HTTP_400_BAD_REQUEST)
